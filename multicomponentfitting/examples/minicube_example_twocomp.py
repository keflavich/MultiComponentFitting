...
guess = {'amp0': 0.3, 'ampdx0': 0, 'ampdy0': 0,
         ...
         'center1': 60, 'centerdx1': 0, 'centerdy1': 0,
...
pymc_medians, pymc_stddevs, trace, pymc_model = \
    minicube_pymc_fit(np.arange(num_pts), model_with_noise, guess, ncomps=2)
...
twocomp_model = multicomp_minicube_model_generator(npix=npix, ncomps=2)
